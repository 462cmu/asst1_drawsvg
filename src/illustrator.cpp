...
void DrawSVG::redraw() {
  ...
  // set svg_to_screen transformation
  Matrix3x3 m_imp = norm_to_screen * viewport_imp[current_tab]->get_svg_to_norm();
  Matrix3x3 m_ref = norm_to_screen * viewport_ref[current_tab]->get_svg_to_norm();
  software_renderer_imp->set_svg_to_screen( m_imp ); 
  software_renderer_ref->set_svg_to_screen( m_ref ); 
